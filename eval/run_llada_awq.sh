...
accelerate launch --num_processes=8 \
    ...
    --model_args pretrained=$1,conv_template=llada,model_name=llava_llada,w_bit=4,q_group_size=128,no_zero_point=False,q_backend=fake,nsamples=128,calib_dataset=c4 \
    --tasks $TASKS \
    --batch_size 1 \
